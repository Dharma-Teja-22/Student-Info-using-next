...
function Page() {
  ...
  const handleLinkClick = () => {
    setIsOpen(false); // Close the dropdown on link click
  };
        ...
        <div className="dropdown">
          ...
          {isOpen && (
            <ul className="menu menu-sm dropdown-content rounded-box z-[1] mt-3 w-52 p-2 shadow bg-black text-white">
              <li>
                <Link href={'/portal'} onClick={handleLinkClick}>Homepage</Link>
              </li>
              <li>
                <Link href={'/info'} onClick={handleLinkClick}>Student Info</Link>
              </li>
              <li>
